  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <div id="content">
        ...
        <form action="admin_change_password1.php" method="POST" >
            <div class="container">
            <center>  <h3 class="header">Change YOur Password</h3> </center>  
            <hr>  
  <div>

    <label>Current Password</label>
    <input type="password" name="currentPassword" class="txtField" size="15" id="currentPassword" class="required">
...
<div>
     <label>Confirm Password</label>
                <input type="password" name="confirmPassword" size="15"
                    class="txtField" id="confirmPassword"
                    class="required">
